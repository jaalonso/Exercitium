...
module A2014.M06.Indices_verdaderos where
...
specG indicesVerdaderos = do
  it "e1" $
    take 6 (indicesVerdaderos [1,4]) `shouldBe`
      [False,True,False,False,True,False]
  it "e2" $
    take 6 (indicesVerdaderos [0,2..]) `shouldBe`
      [True,False,True,False,True,False]
  it "e3" $
    take 3 (indicesVerdaderos []) `shouldBe`
      [False,False,False]
  it "e4" $
    take 6 (indicesVerdaderos [1..]) `shouldBe`
      [False,True,True,True,True,True]
