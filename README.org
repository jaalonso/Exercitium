...
** Próximos
+ 29 [[./src/Metodo_de_Heron_para_calcular_la_raiz_cuadrada.hs][Método de Herón para calcular la raíz cuadrada]].
+ 04 [[./src/Metodo_de_Newton_para_calcular_raices.hs][Método de Newton para calcular raíces]].
