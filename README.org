...
+ + [[./src/Arboles_binarios.hs][El tipo de_los árboles binarios con valores en los nodos y en las hojas]].
...
+ + [[./src/El_tipo_de_los_arboles_binarios.hs][El tipo de_los árboles binarios con valores en los nodos y en las hojas]]. (para borrar)
...
+ V28 [[./src/Pol_Valor_de_un_polinomio_en_un_punto.hs][TAD de los polinomios: Valor de un polinomio en un punto]].
