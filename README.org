...
+ M27 [[./src/Rompecabeza_del_triomino_mediante_divide_y_venceras.hs][Rompecabeza del triominó_mediante divide y vencerás]].
+ X28 [[./src/BusquedaEnProfundidad.hs][Búsqueda en espacios de estados por profundidad]].
+ J29 [[./src/BusquedaEnAnchura.hs][Búsqueda en espacios de estados por anchura]].
+ V30 [[./src/BEE_Reinas.hs][El problema de las n reinas (mediante espacios de estados)]].
