...
+ L30-Ene [[./src/PrefijoPila.hs][TAD de las pilas: Reconocimiento de prefijos de pilas]].
+ M31-Ene [[./src/SubPila.hs][TAD de las pilas: Reconocimiento de subpilas]].
+ X01-Feb [[./src/OrdenadaPila.hs][TAD de las pilas: Reconocimiento de ordenación de pilas]].
+ J02-Feb [[./src/OrdenaInserPila.hs][TAD de las pilas: Ordenación de pilas por inserción]].
+ V03-Feb [[./src/NubPila.hs][TAD de las pilas: Eliminación de repeticiones en una pila]].
+ L06-Feb [[./src/MaxPila.hs][TAD de las pilas: Máximo elemento de una pila]].
+ M07-Feb [[./src/TAD/Cola.hs][El tipo abstracto de datos de las colas]].
+ M07-Feb [[./src/TAD/ColaConListas.hs][El tipo de datos de las colas mediante listas]].
+ M07-Feb [[./src/TAD/ColaConSucesiones.hs][El tipo de datos de las colas mediante sucesiones]].
+ M07-Feb [[./src/TAD/ColaConDosListas.hs][El tipo de datos de las colas mediante dos listas]].
+ X08-Feb [[./src/Transformaciones_colas_listas.hs][TAD de las colas: Transformaciones entre colas y listas]].
...
+ X01-Mar [[./src/Transformaciones_conjuntos_listas.hs][TAD de los conjuntos: Transformaciones entre conjuntos y listas]].
