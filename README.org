...
+ 12 [[./src/Juego_de_bloques_con_letras.hs][Juego de bloques con letras]].
+ 15 [[./src/Permutacion_de_consecutivos.hs][Permutación de elementos consecutivos]].
+ 16 [[./src/Representaciones_de_matrices.hs][Representaciones de matrices]].
+ 17 [[./src/Elementos_adicionales.hs][Elementos adicionales]].
+ 18 Fractal de la curva del dragón
+ 19 [[./src/Raiz_de_suma_de_tres_cubos.hs][2015 como raíz cuadrada de la suma de tres cubos]].
+ 22 [[./src/Numeros_cuya_suma_de_digitos_es_su_numero_de_divisores.hs][2015, suma de dígitos y número de divisores]].
+ 23 [[./src/Desemparejamiento_de_listas.hs][Desemparejamiento de listas]].
+ 24 [[./src/Puntos_en_regiones_rectangulares.hs][Puntos en regiones rectangulares]].
+ 26 [[./src/Elementos_mas_frecuentes.hs][Elementos más frecuentes]].
+ 29 [[./src/Enumeracion_de_pares_de_naturales.hs][Enumeración de los pares de números naturales]].
+ 30 [[./src/La_funcion_suelo.hs][La función suelo]].
+ 31 [[./src/Periodo_de_una_lista.hs][Período de una lista]].

** Ejercicios publicados el 2015

*** Enero 2015
+ 01 [[./src/Numeros_con_factorizacion_capicua.hs][2015 y los números con factorización capicúa]].
+ 02 [[./src/Simplificacion_de_expresiones_booleanas.hs][Simplificación de expresiones booleanas]].
+ 05 Dos cuadrados encajados
+ 06 Varios cuadrados encajados
+ 07 Varios cuadrados encajados rotando
+ 08 [[./src/Numeros_pitagoricos.hs][2015 y los números pitagóricos]].
+ 09 [[./src/Triangulos_de_Heron.hs][Triángulos de Herón]].
+ 12 [[./src/Listas_disjuntas.hs][Listas disjuntas]].
+ 13 [[./src/Maxima_suma_de_segmentos.hs][Máxima suma de los segmentos]].
+ 14 [[./src/Conjuntos_de_puntos_enteros_en_regiones_rectangulares.hs][Conjuntos de puntos enteros en regiones rectangulares]].
+ 15 [[./src/Mezcla_de_infinitas_listas_infinitas.hs][Mezcla de infinitas listas infinitas]].
+ 16 [[./src/Ordenacion_segun.hs][Ordenación según una función]].
+ 19 [[./src/Suma_de_un_lista_de_vectores.hs][Suma de una lista de vectores]].
+ 20 [[./src/Listas_con_suma_dada.hs][Listas con suma dada]].
+ 21 [[./src/Triparticiones_de_una_lista.hs][Triparticiones de una lista]].
+ 22 [[./src/Sustitucion_de_listas.hs][Sustitución de listas]].
+ 23 [[./src/Enumeracion_de_los_enteros.hs][Enumeración de los números enteros]].
+ 26 [[./src/Numeros_naturales_separados_por_ceros.hs][Números naturales separados por ceros]].
+ 27 [[./src/Particiones_en_listas_de_segmentos.hs][Particiones en listas de segmentos]].
+ 28 [[./src/Division_segun_una_propiedad.hs][División según una propiedad]].
+ 29 [[./src/Posicion_del_primer_falso_en_un_vector.hs][Posición del primer falso en un vector]].
+ 30 [[./src/Numeros_polidivisibles.hs][Números polidivisibles]].

*** Febrero 2015
+ 02 [[./src/Siguiente_elemento_en_una_lista.hs][Siguiente elemento en una lista]].
+ 03 [[./src/Mayor_capicua_producto_de_dos_numeros_de_n_cifras.hs][Mayor capicúa producto de dos números de n cifras]].
+ 04 [[./src/Minimo_producto_escalar.hs][Mínimo producto escalar]].
+ 05 [[./src/Particiones_de_enteros_positivos.hs][Particiones de enteros positivos]].
+ 06 [[./src/Menor_numero_triangular_con_mas_de_n_divisores.hs][Menor número triangular con más de n divisores]].
+ 09 [[./src/Reconocimiento_de_grandes_potencias_de_2.hs][Reconocimiento de potencias de 2]].
+ 10 [[./src/Segmentos_de_longitud_dada.hs][Segmentos de longitud dada]].
+ 11 [[./src/Diagonales_principales.hs][Diagonales principales de una matriz]].
+ 12 [[./src/Mayor_producto_de_n_digitos_consecutivos_de_un_numero.hs][Mayor producto de n dígitos consecutivos de un número]].
+ 13 [[./src/Sumas_de_dos_abundantes.hs][Sucesión de sumas de dos números abundantes]].
+ 16 [[./src/Sumas_de_4_primos.hs][Sumas de 4 primos]].
+ 17 [[./src/Parejas_de_numeros_y_divisores.hs][Parejas de números y divisores]].
+ 18 [[./src/Sumas_de_divisores_propios.hs][Sumas de divisores propios]].
+ 19 [[./src/Densidad_de_numeros_abundantes.hs][Densidades de números abundantes, perfectos y deficientes]].
+ 20 [[./src/Diagonales_secundarias.hs][Diagonales secundarias de una matriz]].
+ 23 [[./src/Minimo_numero_de_cambios_para_igualar_una_lista.hs][Mínimo número de cambios para igualar una lista]].
+ 24 Matriz zigzagueante
+ 25 Suma de conjuntos de polinomios
+ 26 Mayor diferencia progresiva
+ 27 Numeración con múltiples bases
