...
+ J16-06-22 [[./src/Numeros_para_los_que_mcm.hs][Números para los que mcm(1,2,...n-1) = mcm(1,2,...,n)]].
+ V17-06-22 [[./src/Metodo_de_biseccion_para_aproximar_raices_de_funciones.hs][Método de bisección para aproximar raíces de funciones]].
+ L20-06-22 [[./src/La_sucesion_del_reloj_astronomico_de_Praga.hs][La sucesión del reloj astronómico de Praga]].
+ M21-06-22 [[./src/Codificacion_de_Fibonacci.hs][Codificación de Fibonacci]].
+ X22-06-22 [[./src/Pandigitales_primos.hs][Pandigitales primos]].
+ Pendiente de publicar desde el 21-06-22.
