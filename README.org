...
+ ??? [[./src/PilaConListas.hs][El tipo de las pilas mediante listas]].
+ ??? [[./src/Transformacion_de_listas_en_pilas.hs][Transformación de listas en pilas]].
+ ??? [[./src/FiltraPila.hs][Filtrado de pilas según una propiedad]].
